...
2. Open your terminal and install all the modules with **npm install**.
3. When all modules have been installed, type **node index.js** in the terminal to start the server.
